  ...
  return (
    <div className="container mx-auto py-4 pt-10 px-6 md:px-20 lg:px-32 my-20 w-full overflow-hidden " id="Projects">
      ...
      <div className="flex justify-end items-center mb-8">
        <button className="p-3 bg-gray-200 rounded mr-2" aria-label="Previous Project"><img src={assets.left_arrow} alt="prev" onClick={prevProject}/></button>

        <button className="p-3 bg-gray-200 rounded mr-2" aria-label="Next Project"><img src={assets.right_arrow} alt="Next" onClick={nextProject}/></button>
      </div>
