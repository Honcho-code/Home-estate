    ...
    <div className='pt-10 px-4 md:px-20 lg:px-32 bg-gray-900 w-full overflow-hidden' id='Footer'>
        <div className='container mx-auto flex flex-col md:flex-row justify-between items-center'>
            <div className='w-full md:w-1/3 mb-8 md:mb-0'>
                ...
                <p className='text-gray-400 mt-4'>Welcome to Home 2 Home, your trusted partner in real estate. With years of expertise and a passion for connecting people to their dream properties</p>
            </div>
        ...
        <div className='border-t border-gray-700 py-4 mt-10 text-center text-gray-300'>
            Copyright 2024 @ RaphealClinton. All Right Reserved.
        </div>
    </div>
  )
}
